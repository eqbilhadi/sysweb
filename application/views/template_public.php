<!doctype html>
<html lang="en" data-layout="horizontal" data-layout-style="" data-layout-position="boxed" data-topbar="light">
                    ...
                    <div class="row">
                                                ...
                                                <div id="carouselExampleCaption" class="carousel slide" data-bs-ride="carousel">
                                                    <div class="carousel-inner" role="listbox">
                                                        <div class="carousel-item">
                                                            <img class="d-block img-fluid mx-auto" src="https://www.suararakyatnews.co/wp-content/uploads/2023/09/50abb4cd-209a-49a8-a260-f577192339d1-2-640x350.jpeg" alt="First slide">
                                                            <div class="carousel-caption d-none d-md-block text-white-50 text-lg-start">
                                                                <h5 class="text-white">Ketua Umum IMI Bamsoet Apresiasi Dukungan Organisasi Otomotif Internasional FIA Atas Penyelenggaraan FIA Region II Rountable di Bali</h5>
                                                        ...
                                                        <div class="carousel-item active">
                                                            <img class="d-block img-fluid mx-auto" src="https://www.suararakyatnews.co/wp-content/uploads/2023/09/50abb4cd-209a-49a8-a260-f577192339d1-640x350.jpeg" alt="Second slide">
                                                            <div class="carousel-caption d-none d-md-block text-white-50 text-lg-start">
                                                                <h5 class="text-white">Twibbonize: Kisah Sukses Inovasi Lokal yang Bikin Investor AS Terpikat!</h5>
                                                                <p>Consistency piques people’s interest is that it has become more and more popular over the years, which is excellent.</p>
                                                            </div>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <img class="d-block img-fluid mx-auto" src="https://www.suararakyatnews.co/wp-content/uploads/2023/09/IMG-20230915-WA0029-640x350.jpg" alt="Third slide">
                                                            <div class="carousel-caption d-none d-md-block text-white-50 text-lg-start">
                                                                <h5 class="text-white">Serahkan 12 Unit mobil dan 64 Motor Kepada DPD Partai Golkar Dapil Jateng 7 (Purbalingga, Banjarnegara dan Kebumen), Bamsoet Ajak Hindari Politik Identitas</h5>
                        ...
                        <div class="col-xxl-4">
                            <div class="card">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img class="rounded-start img-fluid h-100 object-cover" src="https://www.suararakyatnews.co/wp-content/uploads/2023/07/KOMISI-iv-100x75.jpg" alt="Card image">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">Respon Firli Bahuri terhadap Tudingan Pemeriksaan Gus Imin</h5>
                                        </div>
                                        <div class="card-body">
                                            <p class="card-text"><small class="text-muted"><b>AdminBerita</b> - Last updated 3 mins ago</small></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img class="rounded-start img-fluid h-100 object-cover" src="https://www.suararakyatnews.co/wp-content/uploads/2023/09/3be14e0c-ced8-4842-b71a-3be6509db287-2-100x75.jpg" alt="Card image">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">Bagaimana Tanggapan Kiai-Kiai Jombang soal Peluang Anies-</h5>
                                        </div>
                                        <div class="card-body">
                                            <p class="card-text"><small class="text-muted"><b>AdminBerita</b> - Last updated 3 mins ago</small></p>
                                        </div>
                            ...
                            <div class="card">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img class="rounded-start img-fluid h-100 object-cover" src="https://www.suararakyatnews.co/wp-content/uploads/2023/09/IMG-20230912-WA0119-100x75.jpg" alt="Card image">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">Dialog Kebangsaan HUT ke-45 FKPPI, Ketua MPR RI...</h5>
                                        </div>
                                        <div class="card-body">
                                            <p class="card-text"><small class="text-muted"><b>AdminBerita</b> - Last updated 3 mins ago</small></p>
                                        </div>
                        ...
                        <div class="col-xl-12">
                            <div class="row mb-0 g-1">
                                <div class="col-xxl col-6">
                                    <div class="card h-80">
                                        <img class="img-fluid" src="https://www.suararakyatnews.co/wp-content/uploads/2023/09/IMG-20230919-WA0087-341x220.jpg" alt="Card image cap" />
                                        <div class="card-body">
                                ...
                                <div class="col-xxl col-6">
                                    <div class="card h-80">
                                        <img class="card-img-top img-fluid" src="https://www.suararakyatnews.co/wp-content/uploads/2023/09/50abb4cd-209a-49a8-a260-f577192339d1-1-341x220.jpeg" alt="Card image cap" />
                                        <div class="card-body">
                                            <h4 class="card-title mb-0">Give your text a good structure?</h4>
                                            <small class="text-muted">Last updated 3 mins ago</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xxl col-6">
                                    <div class="card h-80">
                                        <img class="card-img-top img-fluid" src="https://www.suararakyatnews.co/wp-content/uploads/2023/09/IMG-20230913-WA0097-341x220.jpg" alt="Card image cap" />
                                        <div class="card-body">
                                            <h4 class="card-title mb-0">Manage white space in responsive layouts ?</h4>
                                            <small class="text-muted">Last updated 3 mins ago</small>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-6">
                                            <div class="text-center">
                                                <img src="<?= base_url() ?>assets/images/illustrator-1.png" class="img-fluid" alt="">
                                            </div>
                                        </div><!-- end col -->
                                    </div><!-- end row -->
                                    <div class="mt-3 pt-2">
